...
% EEG data directory 
datadir = '/home/ildiko/Desktop/PROCESSED_Data/batch6';
cd(datadir)
myfiles = dir('*.set'); 
...
%resultsdir = '/home/ildiko/Desktop/EEG_Data/WM/working_memory/results/';

resultsdir = '/home/ildiko/Desktop/RESULTS/RESULTS_batch6';
...
% load the pairing EEG data set
    ...
    name = fullfile(resultsdir, eachresult(eachfile).name);
    load(name);
