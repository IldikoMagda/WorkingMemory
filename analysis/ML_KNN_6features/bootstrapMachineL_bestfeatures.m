...
load('bestfeaturesTABLE6.mat');  
data= bestfeaturesTABLE6; 
tic
...
[trainingdata, predictiondata, predictionclasses, permudata, permclasses] = firstsplit_bestfeatures(data);

%train model and return it, with accuracy
[Trainedmodel, TrainingAccuracy] = trainKNNClassifier_bestf(trainingdata);
...
%save a common confusion matrix for all data 
...
%pretending is normal data but shuffles classes, 
