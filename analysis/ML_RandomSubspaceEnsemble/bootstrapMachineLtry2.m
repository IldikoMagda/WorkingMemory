...
FeatureAndAcc = zeros(19, samplingout); 
...
[Trainedmodel, TrainingAccuracy] = trainSUBSPACEKNNENSEMBLEClassifier(trainingdata);
Features = ExtractFeatures(Trainedmodel); 
FeatureAndAcc(1:18, i)= Features; 
