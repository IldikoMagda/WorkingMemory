...
actualdata = data(:, 1:18); % choose all data only 
...
UNSEENDATA = shuffleddata(:, 1:18); 
UNSEENCLASSES= shuffleddata(:, 19);
...
permutationdataA(:,19) = 0; 
permutationdataB(:, 19) = 1;
